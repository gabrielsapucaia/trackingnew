...
def gerar_ciclos(
    ...
    for i in range(len(carregamentos_validos)):
        ...
        if basculamento:
            ...
            # Cap de duração: basculamento real não pode ser > 256s (3× mediana típica)
            # Se for maior, assume que inclui tempo de espera/ociosa
            MAX_DURACAO_BASCULAMENTO = 256
            basc_duracao_original = basculamento['duration_sec']
            basc_duracao = min(basc_duracao_original, MAX_DURACAO_BASCULAMENTO)
