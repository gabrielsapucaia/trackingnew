...
export default function MonitoramentoOfflineGridLayerPage() {
    ...
    <div className="grid gap-4 items-start" style={{ gridTemplateColumns: "12% 1fr" }}>
      <aside className="rounded-lg border bg-card p-4 shadow-sm sticky top-4 self-start">
        <div className="space-y-3">
          <div>
            <p className="text-sm font-semibold">Offline (GridLayer)</p>
            <p className="text-xs text-muted-foreground">
              Grids em metros (GridLayer) com cores pela velocidade média.
            </p>
          </div>
